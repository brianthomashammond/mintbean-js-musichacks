...
export function playTwinkleTwinkle() {
    ...
    synth.triggerAttackRelease("Db4", "4n", now + 1)
    synth.triggerAttackRelease("Ab4", "4n", now + 2)
    synth.triggerAttackRelease("Ab4", "4n", now + 3)
    synth.triggerAttackRelease("Bb4", "4n", now + 4)
    synth.triggerAttackRelease("Bb4", "4n", now + 5)
    synth.triggerAttackRelease("Ab4", "2n", now + 6)
    synth.triggerAttackRelease("Gb4", "4n", now + 8)
    synth.triggerAttackRelease("Gb4", "4n", now + 9)
    synth.triggerAttackRelease("F4", "4n", now + 10)
    synth.triggerAttackRelease("F4", "4n", now + 11)
    synth.triggerAttackRelease("Eb4", "4n", now + 12)
    synth.triggerAttackRelease("Eb4", "4n", now + 13)
    synth.triggerAttackRelease("Db4", "2n", now + 14)
}
